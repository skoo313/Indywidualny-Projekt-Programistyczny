...
from recognizer import q, get_note #importuje queue i ,maina'
...
while running:
	...
	if b['Cents'] < 15:
            #?
            pygame.draw.circle(screen, (0, 128, 0),(screenWidth // 2 + (int(b['Cents']) * 2),300),10)
	else:
            pygame.draw.circle(screen, (128, 0, 0),(screenWidth // 2 + (int(b['Cents']) * 2), 300),10)
