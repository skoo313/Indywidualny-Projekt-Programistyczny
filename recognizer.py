...
def get_note(volume_thresh=0.001):
	...
	q.put({'Note': current_pitch.nameWithOctave, 'Cents': current_pitch.microtone.cents, 'Vol': volume})

        print("Name: {}".format(current_pitch.nameWithOctave))
	#print("Frequency: {}".format(current_pitch.frequency))
	#print("Volume: {}".format(volume))	
	#print("Pitch: {}".format(pitch))
	#print("NAME: {}".format(current_pitch.fullName))	
	#print("------")
        
        
if __name__ == '__main__':
    get_note(volume_thresh=2)
